...
```bash
cd /Users/drewritter/prime-rad/hyperpowers/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/hyperpowers
...
```bash
node /tmp/hyperpowers-pr1720-security-drewritter/probe-pr1720.cjs
```
