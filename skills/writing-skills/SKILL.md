...
**Personal skills live in your runtime's skills directory** — see [claude-code-tools.md](../using-hyperpowers/references/claude-code-tools.md), [codex-tools.md](../using-hyperpowers/references/codex-tools.md), [copilot-tools.md](../using-hyperpowers/references/copilot-tools.md), or [gemini-tools.md](../using-hyperpowers/references/gemini-tools.md) for the path on your runtime. Codex, Copilot CLI, and Gemini CLI all also recognize `~/.agents/skills/` as a cross-runtime alias.
